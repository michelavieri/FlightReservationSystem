...
//        returnSchedule.getSeatsInventoryEntitys().size();
    ...
    @Override
    public List<NestedList> searchDirectFlightsUnmanaged(String departureAirport, String destinationAirport,
            String departureDate, int numOfPassenger, CabinClassTypeEnum classType) {
    ...
    @Override
    public List<NestedList> searchDirectFlightsBeforeUnmanaged(String departureAirport, String destinationAirport,
            String departureDateTime, int numOfPassenger, CabinClassTypeEnum classType
    ) {
        List<List<FlightScheduleEntity>> finalSchedule = searchDirectFlightsBefore(departureAirport, destinationAirport, departureDateTime, numOfPassenger, classType);
    ...
    @Override
    public List<NestedList> searchDirectFlightsAfterUnmanaged(String departureAirport, String destinationAirport,
            String departureDateTime, int numOfPassenger, CabinClassTypeEnum classType
    ) {
        List<List<FlightScheduleEntity>> finalSchedule = searchDirectFlightsAfter(departureAirport, destinationAirport, departureDateTime, numOfPassenger, classType);
