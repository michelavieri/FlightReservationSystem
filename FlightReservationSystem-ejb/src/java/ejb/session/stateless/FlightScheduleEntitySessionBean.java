...
//        returnSchedule.getSeatsInventoryEntitys().size();
    ...
    @Override
    public List<List<FlightScheduleEntity>> searchDirectFlightsBeforeUnmanaged(String departureAirport, String destinationAirport,
            String departureDateTime, int numOfPassenger, CabinClassTypeEnum classType
    ) {
    ...
    @Override
    public List<List<FlightScheduleEntity>> searchDirectFlightsAfterUnmanaged(String departureAirport, String destinationAirport,
            String departureDateTime, int numOfPassenger, CabinClassTypeEnum classType
    ) {
