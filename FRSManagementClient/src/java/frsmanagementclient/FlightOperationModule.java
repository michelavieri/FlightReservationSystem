...
public class FlightOperationModule {
    ...
    public FlightOperationModule(AirportEntitySessionBeanRemote airportEntitySessionBeanRemote, AircraftTypeEntitySessionBeanRemote aircraftTypeEntitySessionBeanRemote, CabinClassConfigurationSessionBeanRemote cabinClassConfigurationSessionBeanRemote, AircraftConfigurationEntitySessionBeanRemote aircraftConfigurationEntitySessionBeanRemote, FlightEntitySessionBeanRemote flightEntitySessionBeanRemote, FlightRouteEntitySessionBeanRemote flightRouteEntitySessionBeanRemote) {
    ...
    public void createFlightSchedulePlan(Scanner sc) {
        ...
        if(typeResponse == 1) {
            ...
            System.out.println("Expected arrival date and time: " + arrivalDateTime.toString());
            
            FlightScheduleEntity flightSchedule = flightScheduleEntitySessionBeanRemote.createFlightScheduleEntity(new FlightScheduleEntity(departureDate, duration));
            flightSchedule.setDuration(duration);
            flightSchedule.setArrivalDate(arrivalDateTime.toString());
